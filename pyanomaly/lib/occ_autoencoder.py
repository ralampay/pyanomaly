...
from modules.utils import htb
from modules.utils import fetch_threshold
...
class OccAutoencoder:
    ...
    def render(self):
        ...
        # Draw blue lines for other thresholds
#        for t in self.possible_thresholds:
#            if t != self.optimal_threshold:
#                plt.axvline(x=self.optimal_threshold, c='b')
